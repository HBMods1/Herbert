...
🔗 *Media Url* : ${images}`,
        ...
        break
	    case 'playxx': case 'songxx': case 'ytplayxx': {
...
And Again Me (HBMods) 🌚 Who Helped Assemble This Sexy Script !!!`,unicorn, [{"urlButton": {"displayText": "𝗬𝗼𝘂𝗧𝘂𝗯𝗲","url": `${myweb}`}},{"urlButton": {"displayText": "𝗜𝗻𝘀𝘁𝗮𝗴𝗿𝗮𝗺","url": `${sc}`}},{"quickReplyButton": {"displayText": "List Menu🍱","id": 'command'}},{"quickReplyButton": {"displayText": "Owner👤","id": 'owner'}}] )
break
case 'menu': case 'bot': case 'alive':
var unicorn = await getBuffer(picak+'HBEABot')
await HBModsMd.send5ButImg(from, `` + '' + ' ', `─❖
│「 Hi 👋 」
└┬
┌┤「 ${pushname} 」
...
└┬──────────────┈ ⳹
   ...
   └───────────────┈ ⳹`,unicorn, [{"urlButton": {"displayText": "𝗬𝗼𝘂𝗧𝘂𝗯𝗲","url": `${myweb}`}},{"urlButton": {"displayText": "𝗜𝗻𝘀𝘁𝗮𝗴𝗿𝗮𝗺","url": `${sc}`}},{"quickReplyButton": {"displayText": "List Menu🍱","id": 'command'}},{"quickReplyButton": {"displayText": "Owner👤","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
